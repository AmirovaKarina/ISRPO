...
namespace PR7
{
    ...
    {
        private readonly string connectionString = @"Data Source=WIN-07GTU19UB60\SQLEXPRESS;Initial Catalog=Publishing;Integrated Security=True;Connect Timeout=30";
